    ...
    class OrderController {
        ...
        static async createOrder(req, res) {
            ...
            try {
                ...
                // 🔹 Với dine-in thì tableId bắt buộc
                if (finalOrderType === 'dine-in' && !tableId) {
                    return res.status(400).json({
                        message: 'tableId is required for dine-in orders',
                    });
                }

                const openStatuses = ['pending', 'confirmed', 'serving'];
                ...
                // 🔗 Sau khi tạo: nếu dine-in + có bàn → set occupied
        ...
        static async updateOrder(req, res) {
            ...
            try {
                ...
                // Nếu là dine-in, có tableId và chuyển sang completed/cancelled → trả bàn
                if (
